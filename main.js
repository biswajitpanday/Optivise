...
const ENHANCED_FEATURES = process.env.OPTIDEVDOC_ENHANCED === 'true' || process.env.ENHANCED_FEATURES === 'true' || IS_RENDER;
const PRODUCT_DETECTION = process.env.ENABLE_PRODUCT_DETECTION === 'true' || process.env.PRODUCT_DETECTION === 'true' || IS_RENDER;
const RULES_PATH = process.env.RULES_PATH || './rules';
const CORS_ENABLED = process.env.ENABLE_CORS === 'true' || process.env.CORS_ENABLED === 'true' || IS_RENDER;
...
console.error(`• OPTIDEVDOC_ENHANCED: ${process.env.OPTIDEVDOC_ENHANCED}`);
console.error(`• ENABLE_PRODUCT_DETECTION: ${process.env.ENABLE_PRODUCT_DETECTION}`);
console.error(`• ENABLE_CORS: ${process.env.ENABLE_CORS}`);
