...
const ENHANCED_FEATURES = process.env.OPTIDEVDOC_ENHANCED === 'true' || process.env.ENHANCED_FEATURES === 'true';
const PRODUCT_DETECTION = process.env.ENABLE_PRODUCT_DETECTION === 'true' || process.env.PRODUCT_DETECTION === 'true';
const RULES_PATH = process.env.RULES_PATH || './rules';
const CORS_ENABLED = process.env.ENABLE_CORS === 'true' || process.env.CORS_ENABLED === 'true';
